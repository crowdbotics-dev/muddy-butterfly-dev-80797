...
## Project Structure
    ...
    ├── muddy_butterfly_dev_80797  # Django project configurations
...
1. Clone this repo and `cd muddy_butterfly_dev_80797`
...
2. Clone this repo and `cd muddy_butterfly_dev_80797`
